...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card border-0 shadow">
            ...
            <form action="{{ route('medication_record_form.store') }}" method="POST" data-ajax="true">
                ...
                <div class="card-body p-4">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            @include('generate.input', [
                                'label' => 'Nurse Middle Name',
                                'name' => 'nurse_staff_middle_name',
                                'value' => '',
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
