...
@section('content')
    <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <a href="{{ route('blood_glucose_form.create') }}" class="btn btn-primary pull-right">
        ...
        <div class="card border-0 shadow">
            <div class="card-header bg-white py-3">
                <div class="row">
                    <div class="col-md-8 d-flex justify-content-start align-items-center">
                        <h5 class="mb-0">Blood Glucose and Insulin Injection Monitoring Form</h5>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="card-body">
                <div id="datas">
                        @include('forms.blood_glucose_form.list')
                </div>
            </div>
        </div>
    </div>
