        ...
        <tbody>
            @foreach ($list as $dischargeOrdersForm)
                <tr>
                    ...
                    <td>
                        {{ $dischargeOrdersForm->attending_physician_fname . ' ' }}
                        {{ $dischargeOrdersForm->attending_physician_lname }}
                    </td>
                    <td>{{ $dischargeOrdersForm->created_at->format('M d, Y g:i A') }}</td>
                    <td class="">
                        <div class="d-flex justify-content-center">
                            <a class="btn btn-sm btn-primary"
                                href="{{ route('operative_clearance_form.show', $dischargeOrdersForm->id) }}">
                                <i class="fa fa-eye"></i>
                            </a>

                            <a class="btn btn-sm btn-success ms-2"
                                href="{{ route('operative_clearance_form.edit', $dischargeOrdersForm->id) }}">
                            ...
                            @include('shared.delete-item', [
                                ...
                                'url' => route('operative_clearance_form.delete'),
                            ])
                        </div>
                    </td>
                </tr>
