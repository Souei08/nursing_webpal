...
@section('content')
    <div class="container-fluid">
        ...
        <div class="card border-0 shadow">
            ...
            <form action="{{ route('admitting_medical_history_form.update', $patientAdmittingMedicalHistoryForm->id) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            @include('generate.input', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->patient_first_name,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-4">
                            @include('generate.input', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->patient_middle_name,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-4">
                            @include('generate.input', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->patient_last_name,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-4">
                            @include('generate.input', [
                                ...
                                'name' => 'date_of_birth',
                                'type' => 'date',
                                'value' => $patientAdmittingMedicalHistoryForm->date_of_birth,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-4">
                            @include('generate.select', [
                                'label' => 'Sex',
                                'name' => 'sex',
                                'value' => $patientAdmittingMedicalHistoryForm->sex,
                                'options' => [
                                    [
                                        'name' => 'Male',
                                        'value' => 'Male',
                        ...
                        <div class="col-sm-4">
                            @include('generate.input', [
                                ...
                                'type' => 'datetime-local',
                                'value' => $patientAdmittingMedicalHistoryForm->admission_date_time,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-12">
                            @include('generate.textarea', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->chief_complaint,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-6">
                            @include('generate.input', [
                                ...
                                'id' => 'yes_reason',
                                'name' => 'yes_reason',
                                'value' => $patientAdmittingMedicalHistoryForm->yes_reason,
                                'disabled' => true,
                                'required' => true,
                                'formGroupClass' => 'mb-3',
                            ])
                        ...
                        <div class="col-sm-6">
                            @include('generate.input', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->originating_hci_name,
                                'disabled' => true,
                                'required' => true,
                                'formGroupClass' => 'mb-3',
                            ])
                        ...
                        <div class="col-sm-12">
                            @include('generate.textarea', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->present_illness_history,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-12">
                            @include('generate.textarea', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->pertinent_past_medical_history,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-1">
                            @include('generate.input', [
                                'label' => 'G',
                                'name' => 'g',
                                'value' => $patientAdmittingMedicalHistoryForm->g,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-1">
                            @include('generate.input', [
                                'label' => 'P',
                                'name' => 'p',
                                'value' => $patientAdmittingMedicalHistoryForm->p,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-1">
                            @include('generate.input', [
                                'label' => 'LMP',
                                'name' => 'lmp',
                                'value' => $patientAdmittingMedicalHistoryForm->lmp,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-3">
                            @include('generate.input', [
                                'label' => 'Allergies',
                                'name' => 'allergies',
                                'value' => $patientAdmittingMedicalHistoryForm->allergies,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-3">
                            @include('generate.input', [
                                'label' => 'Smoker',
                                'name' => 'smoker',
                                'value' => $patientAdmittingMedicalHistoryForm->smoker,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-3">
                            @include('generate.input', [
                                ...
                                'name' => 'alcohol_drinks',
                                'value' => $patientAdmittingMedicalHistoryForm->alcohol_drinks,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="alteredMentalSensorium"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->altered_mental_sensorium == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="abdominalCrampPain"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->abdominal_cramp_pain == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="anorexia" name="anorexia"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->anorexia == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="bleedingGums"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->bleeding_gums == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="bodyWeakness"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->body_weakness == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="visionBlurring"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->vision_blurring == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="chestpainDiscomfort"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->chestpain_discomfort == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="constipation"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->constipation == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="cough" name="cough"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->cough == true ? 'checked' : '' }}>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="diarrhea" name="diarrhea"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->diarrhea == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="dizziness" name="dizziness"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->dizziness == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="dysphagia" name="dysphagia"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->dysphagia == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="dyspnea" name="dyspnea"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->dyspnea == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="dysuria" name="dysuria"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->dysuria == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="epistaxis" name="epistaxis"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->epistaxis == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="fever" name="fever"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->fever == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="urinationFrequency"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->urination_frequency == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="headache" name="headache"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->headache == true ? 'checked' : '' }}>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="hematemesis"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->hematemesis == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="hematuria" name="hematuria"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->hematuria == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="hemoptysis"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->hemoptysis == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="irritability"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->irritability == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="jaundice" name="jaundice"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->jaundice == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="lowerExtremityEdema"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->lower_extremity_edema == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="myalgia" name="myalgia"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->myalgia == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="orthopnea" name="orthopnea"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->orthopnea == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="pain" name="pain"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->pain == true ? 'checked' : '' }}>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="palpitations"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->palpitations == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="seizures" name="seizures"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->seizures == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="skinRashes"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->skin_rashes == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="stoolBloodyblackTarrymucoid"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->stool_bloodyblack_tarrymucoid == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="sweating" name="sweating"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->sweating == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="urgency" name="urgency"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->urgency == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="vomiting" name="vomiting"
                                            value="true"
                                            {{ $patientAdmittingMedicalHistoryForm->vomiting == true ? 'checked' : '' }}>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="weightLoss"
                                            ...
                                            {{ $patientAdmittingMedicalHistoryForm->weight_loss == true ? 'checked' : '' }}>
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="symptoms_others"
                                        placeholder="others"
                                        {{ $patientAdmittingMedicalHistoryForm->symptoms_others == true ? 'checked' : '' }}>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-12 mt-2">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="general_survey"
                                    id="general_survey_altered_sensorium">
                        ...
                        <div class="col-sm-2 mt-3">
                            @include('generate.input', [
                                ...
                                'id' => 'bp',
                                'name' => 'bp',
                                'value' => $patientAdmittingMedicalHistoryForm->bp,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-2 mt-3">
                            @include('generate.input', [
                                'label' => 'HR',
                                'name' => 'hr',
                                'value' => $patientAdmittingMedicalHistoryForm->hr,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-2 mt-3">
                            @include('generate.input', [
                                'label' => 'RR',
                                'name' => 'rr',
                                'value' => $patientAdmittingMedicalHistoryForm->rr,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-2 mt-3">
                            @include('generate.input', [
                                'label' => 'Temp',
                                'name' => 'temp',
                                'value' => $patientAdmittingMedicalHistoryForm->temp,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-2 mt-3">
                            @include('generate.input', [
                                'label' => '02 Sat %',
                                'name' => 'sat',
                                'value' => $patientAdmittingMedicalHistoryForm->sat,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-1 mt-3">
                            @include('generate.input', [
                                'label' => 'Height',
                                'name' => 'height',
                                'value' => $patientAdmittingMedicalHistoryForm->height,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-1 mt-3">
                            @include('generate.input', [
                                'label' => 'Weight',
                                'name' => 'weight',
                                'value' => $patientAdmittingMedicalHistoryForm->weight,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
                        ...
                        <div class="col-sm-4 mt-3">
                            @include('generate.select', [
                                ...
                                'id' => 'heent',
                                'name' => 'heent',
                                'value' => $patientAdmittingMedicalHistoryForm->heent,
                                'options' => [
                                    [
                            ...
                            @include('generate.input', [
                                ...
                                'id' => 'heent_others',
                                'name' => 'heent_others',
                                'value' => $patientAdmittingMedicalHistoryForm->heent_others,
                                'disabled' => true,
                                'required' => true,
                                'formGroupClass' => 'mb-3',
                            ])
                        ...
                        <div class="col-sm-4 mt-3">
                            @include('generate.select', [
                                ...
                                'id' => 'chest_lungs',
                                'name' => 'chest_lungs',
                                'value' => $patientAdmittingMedicalHistoryForm->chest_lungs,
                                'options' => [
                                    [
                                        'name' => 'Essentially normal',
                                        'value' => 'Essentially normal',
                            ...
                            @include('generate.input', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->chest_lungs_others,
                                'disabled' => true,
                                'required' => true,
                                'formGroupClass' => 'mb-3',
                            ])
                        ...
                        <div class="col-sm-4 mt-3">
                            @include('generate.select', [
                                ...
                                'id' => 'cvs',
                                'name' => 'cvs',
                                'value' => $patientAdmittingMedicalHistoryForm->cvs,
                                'options' => [
                                    [
                                        'name' => 'Essentially normal',
                                        'value' => 'Essentially normal',
                            ...
                            @include('generate.input', [
                                ...
                                'id' => 'cvs_others',
                                'name' => 'cvs_others',
                                'value' => $patientAdmittingMedicalHistoryForm->cvs_others,
                                'disabled' => true,
                                'required' => true,
                                'formGroupClass' => 'mb-3',
                            ])
                        ...
                        <div class="col-sm-4 mt-3">
                            @include('generate.select', [
                                ...
                                'id' => 'abdomen',
                                'name' => 'abdomen_others',
                                'value' => $patientAdmittingMedicalHistoryForm->abdomen_others,
                                'options' => [
                                    [
                                        'name' => 'Essentially normal',
                                        'value' => 'Essentially normal',
                        ...
                        <div class="col-sm-4 mt-3">
                            @include('generate.select', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->skin_extremities,
                                'options' => [
                                    [
                                        'name' => 'Essentially normal',
                                        'value' => 'Essentially normal',
                            ...
                            @include('generate.input', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->skin_extremities_others,
                                'disabled' => true,
                                'required' => true,
                                'formGroupClass' => 'mb-3',
                            ])
                        ...
                        <div class="col-sm-4 mt-3">
                            ...
                            @include('generate.select', [
                                ...
                                'id' => 'neuro_exam',
                                'name' => 'neuro_exam',
                                'value' => $patientAdmittingMedicalHistoryForm->neuro_exam,
                                'options' => [
                                    [
                                        'name' => 'Essentially normal',
                                        'value' => 'Essentially normal',
                            ...
                            @include('generate.input', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->neuro_exam_others,
                                'disabled' => true,
                                'required' => true,
                                'formGroupClass' => 'mb-3',
                            ])
                        ...
                        <div class="col-md-6 mt-3">
                            @include('generate.select', [
                                ...
                                'id' => 'gu',
                                'name' => 'gu',
                                'value' => $patientAdmittingMedicalHistoryForm->gu,
                                'options' => [
                                    [
                                        'name' => 'Essentially normal',
                                        'value' => 'Essentially normal',
                            ...
                            @include('generate.input', [
                                ...
                                'id' => 'gu_others',
                                'name' => 'gu_others',
                                'value' => $patientAdmittingMedicalHistoryForm->gu_others,
                                'disabled' => true,
                                'required' => true,
                                'formGroupClass' => 'mb-3',
                            ])
                        ...
                        <div class="col-sm-6 mt-3">
                            @include('generate.select', [
                                ...
                                'id' => 'digital_rectal',
                                'name' => 'digital_rectal',
                                'value' => $patientAdmittingMedicalHistoryForm->digital_rectal,
                                'options' => [
                                    [
                                        'name' => 'Essentially normal',
                                        'value' => 'Essentially normal',
                            ...
                            @include('generate.input', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->digital_rectal_others,
                                'disabled' => true,
                                'required' => true,
                                'formGroupClass' => 'mb-3',
                            ])
                        ...
                        <div class="col-sm-4 mt-3">
                            @include('generate.select', [
                                'label' => 'EYES OPEN',
                                'name' => 'eyes_open',
                                'value' => $patientAdmittingMedicalHistoryForm->eyes_open,
                                'options' => [
                                    [
                        ...
                        <div class="col-sm-4 mt-3">
                            @include('generate.select', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->best_verbal_response,
                                'options' => [
                                    [
                        ...
                        <div class="col-sm-4 mt-3">
                            @include('generate.select', [
                                ...
                                'name' => 'best_motor_response',
                                'value' => $patientAdmittingMedicalHistoryForm->best_motor_response,
                                'options' => [
                                    [
                                    ...
                                    [
                                        ...
                                        'value' => 'Decorticate Posturing',
                                    ],
                                    [
                                        'name' => '2 - Decerebrate Posturing',
                                        'value' => 'Decerebrate Posturing',
                                    ],
                                    [
                                        'name' => '1 - No response',
                                        'value' => 'No response',
                        ...
                        <div class="col-sm-12">
                            @include('generate.textarea', [
                                ...
                                'value' => $patientAdmittingMedicalHistoryForm->admitting_impression,
                                'formGroupClass' => 'mb-3',
                            ])
                        </div>
