                    ...
                    <td>
                        <div class="d-flex justify-content-center">
                            <a class="btn btn-sm btn-primary"
                                href="{{ route('fluid_balance_sheet_form.show', $flowSheetForm->id) }}">
                                <i class="fa fa-eye"></i>
                            </a>

                            <a class="btn btn-sm btn-success ms-2"
                                href="{{ route('fluid_balance_sheet_form.edit', $flowSheetForm->id) }}">
                            ...
                            @include('shared.delete-item', [
                                ...
                                'type' => 'Forms',
                                'id' => $flowSheetForm->id,
                                'url' => route('fluid_balance_sheet_form.delete'),
                            ])
                        </div>
                    </td>
                </tr>
