...
@section('content')
    <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <a href="{{ route('ward_nurses_progress_notes.create') }}" class="btn btn-primary pull-right">
        ...
        <div class="card border-0 shadow">
            <div class="card-header bg-white py-3">
                <div class="row">
                    <div class="col-md-8 d-flex justify-content-start align-items-center">
                        <h5 class="mb-0">Ward Nurses / Progress Notes</h5>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="card-body">
                <div id="datas">
                    @include('forms.ward_nurses_progress_note.list')
                </div>
            </div>
        </div>
    </div>
