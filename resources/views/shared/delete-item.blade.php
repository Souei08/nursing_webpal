<button type="button" class="btn btn-danger btn-sm ms-2 {{ $class ?? '' }}" style="{{ $style ?? '' }}" data-bs-toggle="modal" data-bs-target="#delete-{{ $type }}-{{ $id }}"><i class="fa-solid fa-trash"></i></button>
